...
L.PopupEx = L.Popup.extend({
	_initLayout: function () {
		...
		var saveButton = this._saveButton = L.DomUtil.create('button', 'popup-save-button', buttonContainer);
		saveButton.innerHTML = 'Save';
		L.DomEvent.disableClickPropagation(saveButton);
		L.DomEvent.on(saveButton, 'click', this._onSaveButtonClick, this);

		var cancelButton = this._cancelButton = L.DomUtil.create('button', 'popup-cancel-button', buttonContainer);
	...
	_onSaveButtonClick: function (e) {
        ...
        marker.setIcon(new baseIcon({iconUrl: "img/icons/" + iconName + ".png"}));
...
L.MarkerEx = L.Marker.extend({
	initialize: function (id, level, x, y, item, icon, title, description, options) {
		...
		this.options.icon = new baseIcon({iconUrl: "img/icons/" + iconName + ".png"});
