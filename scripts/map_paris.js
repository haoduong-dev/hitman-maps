...
dataUrl = "data/marker_paris.json";

// add data follow old method for polyline, PointRed-Winch. polygon
...
allMarkers = L.layerGroup([
    ...
    L.marker([70.58, -27.42], {icon: iconPointRed, alt: "level1sab-chandelier"}).bindLabel("Winch").bindPopup("<h2>Sabotage</h2><h1>Winch</h1><p class='item-use'>Release Winch</p><p class='susp'>Suspicious in any disguise</p>"),
    L.marker([67.84, -10.89], {icon: iconPointRed, alt: "level1sab-chandelier"}).bindLabel("Winch").bindPopup("<h2>Sabotage</h2><h1>Winch</h1><p class='item-use'>Release Winch</p><p class='susp'>Suspicious in any disguise</p>"),
